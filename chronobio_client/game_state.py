...
class Field:
    ...
    def __init__(self, data: Dict[str, Any]) -> None:
        ...
        if content and content != "NONE":
            self.vegetable: Optional[str] = content
        else:
            self.vegetable: Optional[str] = data.get("vegetable")
...
class Tractor:
    ...
    def __init__(self, data: Dict[str, Any]) -> None:
        ...
        self.worker: Optional[int] = data.get("worker")
...
class Worker:
    ...
    def __init__(self, data: Dict[str, Any]) -> None:
        ...
        self.number: int = data.get("number", 0)
        self.location: int = data.get("location", 0)
        self.tractor: Optional[int] = data.get("tractor")
...
class GameState:
    ...
    def get_field(self, field_number: int) -> Optional[Field]:
    ...
    def get_available_fields(self) -> List[int]:
        ...
        return sorted(list(all_fields - owned_fields))

    def get_next_field_to_buy(self) -> Optional[int]:
        """Retourne le prochain champ à acheter."""
        available = self.get_available_fields()
        return available[0] if available else None

    def get_worker(self, worker_number: int) -> Optional[Worker]:
    ...
    def get_tractor(self, tractor_number: int) -> Optional[Tractor]:
